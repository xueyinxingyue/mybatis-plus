...
public class Generator {
    public static void main(String[] args) {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/mp?serverTimezone=GMT%2B8");
        ...
        packageConfig.setParent("com.xueyin.demo");
        //设置实体类包名
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return System.getProperty("user.dir") +
                        "/src/main/resources/com/xueyin/demo/mapper/" + tableInfo.getEntityName() + "Mapper" +
                        StringPool.DOT_XML;
            }
        });
        ...
        strategyConfig.setInclude("department");
